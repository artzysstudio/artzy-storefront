...
export const legalPolicyPages: Record<string, PageDefinition> = {
  ...
  'returns-policy': page('returns-policy', 'Returns and damage', 'Eligibility and the process for reporting damage, incorrect items, replacements and refunds.', [
    studioIdentity,
    { heading: 'Inspect your order', paragraphs: ['Inspect the parcel and item as soon as it arrives. For damage, an incorrect item or a material mismatch, contact us promptly with the order reference and clear photographs or video. Keep the item, label and packaging during review.'] },
    ...
    { heading: 'What normally does not qualify', bullets: ['Change of mind after production or dispatch.', 'Natural variations in colour, grain, texture, brushwork or finish, or screen-colour differences.', 'Normal wear, misuse, accidental damage, unsuitable water exposure or unauthorised alteration.', 'Personalised, commissioned, made-to-order, downloaded or final-sale work, except for damage, defect or material mismatch.'] },
    { heading: 'Assessment and resolution', paragraphs: ['We may request more evidence or an authorised return. If accepted, the appropriate resolution may be repair, replacement, store credit or refund. Do not return an item until written instructions are provided.'] },
    { heading: 'Refund timing', paragraphs: ['An approved refund is initiated to the original payment method after assessment or receipt of an authorised return. Bank and payment-provider processing time is outside our direct control. Statutory consumer rights remain unaffected.'] },
  ...
  'cancellation-policy': page('cancellation-policy', 'Cancellation', 'When an order can be cancelled and how payment reversals are handled.', [
    ...
    { heading: 'Personalised and commissioned work', paragraphs: ['Cancellation may be unavailable after proof approval, material procurement or production. If accepted, documented completed work, non-recoverable materials and payment or logistics costs may be deducted.'] },
