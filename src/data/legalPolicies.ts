...
export const legalPolicyPages: Record<string, PageDefinition> = {
  ...
  'terms-and-conditions': page('terms-and-conditions', 'Terms and conditions', 'Terms governing catalogue purchases, custom work, payments, digital concepts and use of this website.', [
    ...
    { heading: 'Products, stock and pricing', paragraphs: ['The published studio catalogue controls live availability, variants and stock. Adding to the bag does not reserve an item. Prices are in Indian rupees. An obvious technical or pricing error may be corrected before acceptance, with an option to reconfirm or cancel.'] },
  ...
  'ai-concept-disclosure': page('ai-concept-disclosure', 'AI concept disclosure', 'What an ArtzyAI preview means, how uploads are handled and when the studio becomes involved.', [
    studioIdentity,
    { heading: 'Concept, not stock or proof', paragraphs: ['Artzy Muse and ArtzyAI images are imaginative previews. They are not catalogue stock, Deepti’s original artwork, a manufacturing guarantee, a production proof or a confirmed order. Every generated result is labelled as an AI concept.'] },
