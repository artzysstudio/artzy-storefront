...
const finishes: Finish[] = [
  ...
  { id: 'paper', name: 'Fine-art paper', note: 'Archival-style paper suited to framing.', price: [2490, 6990], framing: 'Frame not included unless quoted', material: 'Paper specification confirmed by ERP/studio', usage: 'Physical print; digital reproduction rights excluded' },
  { id: 'canvas', name: 'Canvas', note: 'A tactile wall-art finish.', price: [3490, 9990], framing: 'Stretcher/frame detail confirmed before production', material: 'Canvas specification confirmed by ERP/studio', usage: 'Physical artwork for the agreed location' },
...
export default function DigitalArtPlanner() {
  ...
  const payload = useMemo(() => ({
    ...
    artzyAiAssetId: assetId, estimate: { label: estimate, authority: 'ERP confirmation required' }, requiredDate: requiredDate || null,
  ...
  const message = useMemo(() => [
    ...
    `Indicative range: ${estimate}. ERP reference: ${reference || 'not created yet'}.`,
  ...
  return <section className="digital-planner digital-wizard" id="digital-planner" aria-labelledby="digital-planner-title">
    <header className="digital-planner__heading"><div><span>Guided digital art planner</span><h2 id="digital-planner-title">Five clear choices.<br/><em>One useful studio brief.</em></h2></div><p>Plan art for a wall, gift, digital use or commercial space. Nothing here invents ERP stock or changes a confirmed price.</p></header>
