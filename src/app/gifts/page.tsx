...
export default async function GiftsPage() {
  ...
  return <><Header/><main className="gift-concierge-page">
    <section className="gift-concierge-hero gift-concierge-hero--illustrated">
      ...
      <div className="gift-concierge-hero__copy"><span>Handmade in Pune · chosen for someone special</span><h1>A gift should say,<br/><em>“I saw you.”</em></h1><p>Choose a hand-painted piece that carries warmth, colour and the unmistakable touch of Deepti&apos;s studio—from one heartfelt surprise to a beautifully planned celebration.</p><div><a href="#gift-quick-start">Help me choose a gift</a><Link href="/shop">Browse all studio pieces</Link></div><small>Artzy-style illustration · Gifts matched from current studio availability</small></div>
      <a className="gift-packages-hero__peek" href="#gift-quick-start">Find their perfect gift <span aria-hidden="true">↓</span></a>
    </section>
    <div className="gift-trust-strip"><span><b>Real stock first</b> Current studio products</span><span><b>Clear budgets</b> Full price breakdown</span><span><b>Human confirmation</b> For custom work &amp; timelines</span></div>
    <GiftBuilder products={products}/>
    <CreativeConceptBuilder kind="gift"/>
    <section className="gift-seo-links"><div><span>Explore by moment</span><h2>Every reason to make someone feel seen.</h2></div><div>{[['Wedding gifts','wedding'],['Birthday gifts','birthday'],['Housewarming gifts','housewarming'],['Festival gifts','festival'],['Employee gifts','corporate'],['Client gifts','corporate'],['Return gifts','return-gift'],['Anniversary gifts','anniversary']].map(([label, occasion]) => <Link href={`/gifts/?occasion=${occasion}#gift-finder`} key={label}>{label}<span>→</span></Link>)}</div></section>
    <section className="gift-studio-cta"><div><span>Can’t find the exact fit?</span><h2>A custom gift begins with a conversation.</h2></div><p>Share a photograph, story, palette, company brief or quantity. Deepti&apos;s studio will confirm what can be made, the exact cost and a realistic delivery date.<br/><Link href="/for-business">Discuss a custom or corporate gift →</Link></p></section>
  </main><Footer/></>;
}
