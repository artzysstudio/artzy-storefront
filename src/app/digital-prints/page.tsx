...
export default function DigitalPrintsPage() {
  return <>
    ...
    <section className="example-gallery">
      <div className="gallery-heading"><div><span className="service-eyebrow">Made to fit real spaces</span><h2>Four directions, designed around your brief.</h2></div><span className="swipe-hint">Swipe to explore →</span></div>
      <div className="example-track">
        <article className="example-slide"><div className="example-art example-art-1" role="img" aria-label="Modern organic abstract art displayed in a living room" /><div><span>Living room focal art</span><h3>Modern Statement</h3></div></article>
        <article className="example-slide"><div className="example-art example-art-2" role="img" aria-label="Expressive abstract art created for home decor" /><div><span>Colour-led home décor</span><h3>Abstract Harmony</h3></div></article>
        <article className="example-slide"><div className="example-art example-art-3" role="img" aria-label="Geometric digital artwork displayed in a modern reception" /><div><span>Contemporary office décor</span><h3>Geometric Rhythm</h3></div></article>
        <article className="example-slide"><div className="example-art example-art-4" role="img" aria-label="Custom corporate digital artwork displayed in a boardroom" /><div><span>Corporate and hospitality art</span><h3>Bespoke Brand Story</h3></div></article>
      </div>
    </section>
    ...
    <section className="service-process"><span className="service-eyebrow">Simple custom workflow</span><h2>From your brief to a finished canvas.</h2><ol><li><strong>Share</strong><span>Your wall photo, size, colours and inspiration.</span></li><li><strong>Imagine</strong><span>We shape an artistic direction around your space and brief.</span></li><li><strong>Create</strong><span>We develop and refine your artwork.</span></li><li><strong>Deliver</strong><span>Your print arrives ready for its new space.</span></li></ol><div className="service-actions center"><Link className="service-secondary" href="/contact/">Start Your Project</Link></div></section>
    </main>
    <Footer />
  </>;
}
