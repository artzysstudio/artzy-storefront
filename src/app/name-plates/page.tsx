...
export default function NamePlatesPage() {
  return <><Header/><main className="name-plates-page">
    ...
    <nav className="plate-page-nav" aria-label="Name plate page sections"><a href="#plate-directions"><b>1</b><span>Find your style<small>Compare six clear directions</small></span></a><a href="#name-plate-builder"><b>2</b><span>Build your plate<small>See choices and estimate</small></span></a><a href="#plate-before-order"><b>3</b><span>Prepare correctly<small>Measure, photograph, confirm</small></span></a></nav>
