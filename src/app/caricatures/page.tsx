...
export default function CaricaturesPage() {
  return <><Header/><main className="service-page caricature-page">
    ...
    <section className="caricature-explainer" id="caricature-examples">
      <div className="caricature-explainer__copy"><span className="service-eyebrow">Photo → caricature</span><h2>Still recognisably them.<br/><em>Now full of story.</em></h2><p>A caricature keeps the familiar face, pose and personality from a photograph, then adds expressive illustration, colour and meaningful details. It works beautifully when an ordinary photo needs to become a memorable, display-worthy gift.</p><div className="caricature-benefits"><p><b>Personal</b><span>Built around their face, interests and occasion.</span></p><p><b>Easy to explore</b><span>See an AI direction before discussing the final artwork.</span></p><p><b>Gift-ready</b><span>Choose a digital file, print, frame, canvas or presentation.</span></p></div></div>
      <figure className="caricature-explainer__visual"><img src="/images/caricature-photo-to-art-demo.webp" alt="Fictional Indian couple shown as a reference photograph and matching watercolour caricature illustration"/><div><span>Fictional reference photograph</span><span>AI illustration demonstration</span></div><figcaption>Demonstration created to explain the service · not a customer photograph or ERP product</figcaption></figure>
    </section>
