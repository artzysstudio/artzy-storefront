...
export default function PremiumHero({ imageUrl }: { imageUrl: string }) {
  return <section className="handmade-hero" aria-labelledby="handmade-hero-title">
    <img className="handmade-hero__image" src={imageUrl} alt="A handmade piece currently available from Artzy's Studio" />
    ...
    <style jsx>{`
      ...
      .handmade-hero{min-height:clamp(520px,62svh,660px)}.handmade-hero__image{object-fit:contain;background:#eadfd4}
    `}</style>
  </section>;
}
